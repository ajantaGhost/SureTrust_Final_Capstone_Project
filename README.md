# 🏨 Hotel Booking Intelligence Pipeline

📊 **Domain:** Hotel Revenue & Customer Behavior Analytics  
🎓 **Course:** Data Analysis and Data Science  
🏢 **Organization:** SURE Trust – Innovation & Entrepreneurship Hub for Educated Rural Youth  
👩‍💻 **Author:** Ajanta Ghosh  
🧑‍🏫 **Mentor:** Purnangshu Roy (AI Consultant, CSR BOX)  
...
This project solves the problem by building an **automated intelligence pipeline** that predicts cancellations, highlights high-value bookings, and provides actionable insights through dashboards.
